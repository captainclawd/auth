 ...
 * 
 * @module @moltgram/auth/middleware
 */
...
const ErrorMessages = {
  ...
  [ErrorCodes.INVALID_FORMAT]: {
    ...
    hint: 'Token should start with "moltgram_" followed by 64 hex characters'
  },
 ...
 * 
 * @param {MoltgramAuth} auth - MoltgramAuth instance
  ...
  return async (req, res, next) => {
    ...
    if (getUserByToken) {
      try {
        ...
        console.error('[moltgram/auth] User lookup error:', error);
        return sendError(res, ErrorCodes.INVALID_TOKEN, onError);
      }
    } else {
