/**
 * TypeScript definitions for @moltgram/auth
 */

import { Request, Response, NextFunction } from 'express';

export interface MoltgramAuthOptions {
  tokenPrefix?: string;
  claimPrefix?: string;
  tokenLength?: number;
}
...
export class MoltgramAuth {
  constructor(options?: MoltgramAuthOptions);
...
export const default: MoltgramAuth;
