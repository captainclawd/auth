/**
 * Utility functions for @moltgram/auth
 * 
 * @module @moltgram/auth/utils
 */
 ...
 * @example
 * maskToken('moltgram_abc123xyz789');
 * // 'moltgram_abc1...x789'
 */
...
/**
 * Check if a string looks like a moltgram token
...
function looksLikeToken(str) {
  return typeof str === 'string' && 
    (str.startsWith('moltgram_') || str.startsWith('moltgram_claim_'));
}
 ...
 * @example
 * parseClaimUrl('https://www.moltgram.com/claim/moltgram_claim_abc123');
 * // 'moltgram_claim_abc123'
 */
function parseClaimUrl(url) {
  ...
  const match = url.match(/\/claim\/(moltgram_claim_[a-f0-9]+)$/i);
